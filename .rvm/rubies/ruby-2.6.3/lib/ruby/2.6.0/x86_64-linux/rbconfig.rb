...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/home/ec2-user/.rvm/rubies/ruby-2.6.3")
  ...
  CONFIG["configure_args"] = " '--prefix=/home/ec2-user/.rvm/rubies/ruby-2.6.3' '--disable-install-doc' '--enable-shared'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/home/ec2-user/.rvm/rubies/ruby-2.6.3"
  ...
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "gcc (GCC) 7.2.1 20170915 (Red Hat 7.2.1-2)\nCopyright (C) 2017 Free Software Foundation, Inc.\nThis is free software; see the source for copying conditions.  There is NO\nwarranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE."
